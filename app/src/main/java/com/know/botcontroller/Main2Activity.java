...
public class Main2Activity  extends SurfaceView implements SurfaceHolder.Callback,View.OnTouchListener {
   ...
   //MainActivity IP = new MainActivity();
    ...
    public Main2Activity(Context context) throws UnknownHostException {
    ...
    public Main2Activity(Context context, AttributeSet attributes, int style) throws UnknownHostException {
    ...
    public Main2Activity(Context context, AttributeSet attributes) throws UnknownHostException {
